...
st.title("🏠 Sistema Reestrenado de Asignaciones")
st.markdown("---")

if "pagina_actual" not in st.session_state:
    st.session_state.pagina_actual = "📋 Mesa de Asignaciones"

# Botones de navegación en barra superior
c_btn1, c_btn2, c_btn3 = st.columns(3)
with c_btn1:
    if st.button("📋 Ir a Mesa de Asignaciones", use_container_width=True):
        st.session_state.pagina_actual = "📋 Mesa de Asignaciones"
with c_btn2:
    if st.button("👥 Ir a Gestión de Hermanos", use_container_width=True):
        st.session_state.pagina_actual = "👥 Gestión de Hermanos"
with c_btn3:
    if st.button("📝 Ir a Pegar Programa JW", use_container_width=True):
        st.session_state.pagina_actual = "📝 Pegar Programa JW"

st.markdown(f"### Sección Activa: {st.session_state.pagina_actual}")

if st.session_state.pagina_actual == "📋 Mesa de Asignaciones":
...
elif st.session_state.pagina_actual == "👥 Gestión de Hermanos":
...
elif st.session_state.pagina_actual == "📝 Pegar Programa JW":
